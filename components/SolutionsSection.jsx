...
export default function SolutionsSection() {
  return (
    <div className='flex flex-col relative items-center justify-center bg-gradient-to-b from-[#8000ff] via-[#bf95e9] to-[#e4cbfc] overflow-hidden h-screen w-11/12 mx-auto rounded-3xl my-10'>
      ...
      <div className='mb-64'>
        <h1 className='text-3xl text-center text-white'>From Chaos to Control -<br />  Simplify your Shipments</h1>
      ...
      <div className='flex items-center justify-center absolute -bottom-10 -space-x-10'>
        <img src="https://u-sendfulfillment.com/wp-content/uploads/2023/09/grabee-modules-hero-lg-1-1536x384.png" alt="" />
      </div>
